...
export default function Footer() {
  return (
    <footer className="bg-surface py-8 border-t border-border/60">
      <div className="mx-auto w-full max-w-7xl px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <nav className="flex flex-wrap justify-center md:justify-end gap-6">
            <Link href="#features" className="text-muted hover:text-purple-400 transition-colors">
              Features
            </Link>
            <Link href="#how-it-works" className="text-muted hover:text-purple-400 transition-colors">
              How It Works
            </Link>
            <Link 
